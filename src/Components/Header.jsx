        ...
        <div className="w-full  flex flex-col items-center md:items-start">
          <div className="flex flex-col md:flex-row justify-center mt-4 space-x-0 md:space-x-4">
            ...
            <div className="flex items-center gap-2 px-10 py-6  md:w-[300px]">
              ...
              <div className="flex flex-col  ">
                <p className=" md:text-lg lg:text-xl font-bold">Start at 11AM IST</p>
          ...
          <div className="mt-6 bg-[#a4dacd] w-full lg:min-w-[400px] lg:max-w-[500px] p-6 rounded-xl border-2 border-blue-500">
            <p className=" md:text-[16px] lg:text-[20px]">
              Enhance your <span className='font-bold'>concentration and clarity</span> for better productivity and <span className='font-bold'>achieve profound inner peace</span> and emotional well-being.
            </p>
          </div>

          <div className="mt-8 flex  w-full flex-col items-center gap-4 justify-center">
            <button className="md:text-[16px] lg:text-[20px] text-white font-bold py-4 px-20 rounded-full bg-yellow-300">
              Book Your Free Spot
            </button>
