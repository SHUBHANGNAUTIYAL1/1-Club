...
const ChangeInLife = () => {
  return (
    <div className="font-serif flex flex-col items-center justify-center p-8  min-h-screen">
      <h1 className="text-white text-3xl font-bold mb-8 mt-20 animate-bounce">What it will change in Your Life</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          { emoji: "😊", text: "You will feel more emotionally stable & Balanced" },
          { emoji: "🏆", text: "You will achieve all your Goals in 2024" },
          { emoji: "👪", text: "Your relationship with your partner, family and friends will get better" },
          { emoji: "💸", text: "You will attract more money and abundance" },
          { emoji: "🔄", text: "You won't repeat the toxic patterns in your life anymore" },
          { emoji: "🚀", text: "You will STOP procrastinating and become an achiever with high self confidence" },
        ].map((item, index) => (
          <div
            key={index}
